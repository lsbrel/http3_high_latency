...
func Http3Usecase() {
	...
	serverConfigs := configs.ServerConfig{Host: "0.0.0.0:8443", Cert: "/etc/letsencrypt/live/lskr.com.br/fullchain.pem", Key: "/etc/letsencrypt/live/lskr.com.br/privkey.pem"}
